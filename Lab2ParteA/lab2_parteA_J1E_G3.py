...
class lab2_parteA_J1E_G3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_parteA_J1E_G3")
...
def main(top_block_cls=lab2_parteA_J1E_G3, options=None):
