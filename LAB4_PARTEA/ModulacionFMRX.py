...
# Title: Demodulacion FM de emisoras
...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Demodulacion FM de emisoras", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulacion FM de emisoras")
        ...
        self._fcb_win = RangeWidget(self._fcb_range, self.set_fcb, "Frecuencia corte del filtro", "counter_slider", float, QtCore.Qt.Horizontal)
