...
class lab1_parteB_Punto6_J1E_G3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab1_PB_P6", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1_PB_P6")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_parteB_Punto6_J1E_G3")
        ...
        self._G_range = Range(1, 10, 1, 1, 200)
        self._G_win = RangeWidget(self._G_range, self.set_G, "Ganancia", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Documents/LabComuI_J1E_G3/lab_comu1_J1E_G3/James_Arthur_-_Impossible_Cover_The_Make_Believe_84r_mg71soc (mp3cut.net).wav', True)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(G)
    ...
    def set_G(self, G):
        self.G = G
        self.blocks_multiply_const_vxx_0.set_k(self.G)
...
def main(top_block_cls=lab1_parteB_Punto6_J1E_G3, options=None):
