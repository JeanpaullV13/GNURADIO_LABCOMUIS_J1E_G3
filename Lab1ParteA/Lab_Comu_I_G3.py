...
class Lab_Comu_I_G3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Primer_Flujograma", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Primer_Flujograma")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_Comu_I_G3")
...
def main(top_block_cls=Lab_Comu_I_G3, options=None):
