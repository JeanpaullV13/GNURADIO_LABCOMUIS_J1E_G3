...
from lab3_parteA_Punto1_J1E_G3 import lab3_parteA_Punto1_J1E_G3  # grc-generated hier_block



from gnuradio import qtgui

class PruebaPotencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PruebaPotencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PruebaPotencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaPotencia")
        ...
        self._FM_range = Range(0, 10000, 10, 1000, 200)
        self._FM_win = RangeWidget(self._FM_range, self.set_FM, "Frecuencia BANDABASE", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.lab3_parteA_Punto1_J1E_G3_0 = lab3_parteA_Punto1_J1E_G3(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.lab3_parteA_Punto1_J1E_G3_0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.lab3_parteA_Punto1_J1E_G3_0, 0))
...
def main(top_block_cls=PruebaPotencia, options=None):
