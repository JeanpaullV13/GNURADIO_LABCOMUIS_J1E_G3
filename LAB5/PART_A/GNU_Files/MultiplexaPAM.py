...
# Title: MultiplexaPAM
# Author: sebastian_suarez_jeanpaull_valencia_J1E_G3
# Copyright: sebastian_suarez_jeanpaull_valencia_J1E_G3
...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = int(200e3)
        ...
        self._LPF_range = Range(0, 10e3, 10, 100, 200)
        self._LPF_win = RangeWidget(self._LPF_range, self.set_LPF, "Frecuencia de corte LPF", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._LPF_win)
        self._D5_range = Range(0, 100, 1, 0, 200)
        self._D5_win = RangeWidget(self._D5_range, self.set_D5, "DMUX", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Documents/LabComuI_J1E_G3/LAB5/Parte A/UEFA Champions League Anthem (Full Version).wav', True)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_float*1)
        self.blocks_delay_1 = blocks.delay(gr.sizeof_float*1, (100-D5))
        self.blocks_delay_0_2 = blocks.delay(gr.sizeof_float*1, D4)
        self.blocks_delay_0_1 = blocks.delay(gr.sizeof_float*1, D1)
        ...
        self.connect((self.ModulacionPAM_0, 1), (self.blocks_null_sink_0, 0))
        self.connect((self.ModulacionPAM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModulacionPAM_0_0, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModulacionPAM_0_0, 1), (self.blocks_null_sink_0, 1))
        self.connect((self.ModulacionPAM_0_1, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.ModulacionPAM_0_1, 1), (self.blocks_null_sink_0, 2))
        self.connect((self.ModulacionPAM_0_2, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModulacionPAM_0_2, 1), (self.blocks_null_sink_0, 3))
        self.connect((self.ModulacionPAM_0_2_0, 0), (self.blocks_delay_0_2, 0))
        self.connect((self.ModulacionPAM_0_2_0, 1), (self.blocks_null_sink_0, 4))
        self.connect((self.ModulacionPAM_1, 1), (self.blocks_null_sink_0, 5))
        self.connect((self.ModulacionPAM_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.ModulacionPAM_1, 1), (self.qtgui_time_sink_x_1, 2))
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_1, 3))
        ...
        self.connect((self.blocks_delay_0_1, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_delay_0_1, 0), (self.qtgui_time_sink_x_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, self.LPF, 100, window.WIN_HAMMING, 6.76))
    ...
    def set_D5(self, D5):
        self.D5 = D5
        self.blocks_delay_1.set_dly(int((100-self.D5)))
    ...
    def set_D4(self, D4):
        self.D4 = D4
        self.blocks_delay_0_2.set_dly(int(self.D4))
    ...
    def set_D3(self, D3):
        self.D3 = D3
        self.blocks_delay_0.set_dly(int(self.D3))
    ...
    def set_D1(self, D1):
        self.D1 = D1
        self.blocks_delay_0_1.set_dly(int(self.D1))
