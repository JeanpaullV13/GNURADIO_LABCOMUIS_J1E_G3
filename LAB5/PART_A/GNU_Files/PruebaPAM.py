...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Modulacion digital", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion digital")
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAM_0, 1), (self.qtgui_freq_sink_x_0, 2))
        ...
        self.connect((self.ModulacionPAM_0, 0), (self.rational_resampler_xxx_0, 0))
